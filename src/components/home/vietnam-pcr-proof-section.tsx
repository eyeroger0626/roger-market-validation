  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 lg:px-8">
        ...
        <article className="mt-12 grid gap-8 rounded-[2rem] border border-white/[0.12] bg-white/[0.1] p-5 shadow-[0_34px_110px_rgba(0,0,0,0.26)] backdrop-blur lg:grid-cols-[0.34fr_0.66fr] lg:items-center lg:p-7">
