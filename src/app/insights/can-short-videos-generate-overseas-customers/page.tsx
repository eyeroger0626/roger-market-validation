...
const article = getInsightArticle("can-short-videos-generate-overseas-customers")!;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: [article.title, "製造業海外獲客系統｜星啟夢圓行銷"].join("\uFF5C"),
    description: [article.description, "星啟夢圓行銷協助台灣製造業持續取得海外 B2B 詢盤，降低對展會與 B2B 平台的依賴。"].join(" "),
    type: "article",
    locale: "zh_TW",
    url: pageUrl,
...
export default function CanShortVideosGenerateOverseasCustomersPage() {
